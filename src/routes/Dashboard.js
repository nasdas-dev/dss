  ...
  return (
    <div className=" bg-base-100  flex flex-col">
      ...
      <div className="hero min-h-screen inline-flex flex-container flex-wrap content-center justify-center">
        <div class="card lg:card-side bg-base-100 shadow-xl max-w-3xl m-12">
          <div
        ...
        <div class="card w-96 bg-base-100 shadow-xl max-w-2xl m-12">
        ...
        <div class="card lg:card-side bg-base-100 shadow-xl max-w-2xl max-h-96 m-12">
